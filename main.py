...
if __name__ == "__main__":
    ...
    parser.add_argument('--starsize', nargs='?', const=9, type=int, default=9)
    parser.add_argument('--downscale', nargs='?', const=2, type=int, default=2)
    args = parser.parse_args()
    toSolve = PlateSolve.PlateSolve(focale=args.focale, photosyte=args.photosite, fov = args.fov, percent = args.percent, star_size = args.starsize, downscale = args.downscale)
